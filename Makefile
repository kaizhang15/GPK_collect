...
$(PUB_DIR): index.html
	@mkdir -p $(PUB_DIR)
	-@cp -r audio/*.mp3 index.html jquery-1.11.1.min.js collect_data_style.css mobile_dev.html predict.js keyboard.min.js style.css buttons.css image/*.png keydown.wav $(PUB_DIR)/
