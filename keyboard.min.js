...
(function($) {
	...
	$.fn.keyboard = function(a) {
		...
		a.keyWidth = a.keyWidth || p((p(a.width) + 25 - p(a.padding) * 2 ) / 15);
		// a.keyWidth = a.keyWidth || p((p(a.width) - p(a.padding) * 2 - p(a.segment) * 2) / 22);
		a.keyHeight = a.keyWidth;
		addDom(b);
		initStyle(b, a);
		addEL(b, a);
		return this
	...
	function addDom(a) {
		var b = '<div class="keyboard_container">    <div class="keyboard_s keyboard_l">  <ul class="keyboard_row">  <li data_index="192" class="keyboard_double">~</br>`</li>  <li data_index="49" class="keyboard_double">!</br>1</li>  <li data_index="50" class="keyboard_double">@</br>2</li>  <li data_index="51" class="keyboard_double">#</br>3</li>  <li data_index="52" class="keyboard_double">$</br>4</li>  <li data_index="53" class="keyboard_double">%</br>5</li>  <li data_index="54" class="keyboard_double">^</br>6</li>  <li data_index="55" class="keyboard_double">&</br>7</li>  <li data_index="56" class="keyboard_double">*</br>8</li>  <li data_index="57" class="keyboard_double">(</br>9</li>  <li data_index="48" class="keyboard_double">)</br>0</li>  <li data_index="189" class="keyboard_double">—</br>-</li>  <li data_index="187" class="keyboard_double">+</br>=</li>  <li data_index="" class="keyboard_w2"></li>    	</ul>    	<ul class="keyboard_row">  <li data_index="" class="keyboard_w3_2"></li>  <li data_index="81">Q</li>  <li data_index="87">W</li>  <li data_index="69">E</li>  <li data_index="82">R</li>  <li data_index="84">T</li>  <li data_index="89">Y</li>  <li data_index="85">U</li>  <li data_index="73">I</li>  <li data_index="79">O</li>  <li data_index="80">P</li>  <li data_index="219" class="keyboard_double">{</br>[</li>  <li data_index="221" class="keyboard_double">}</br>]</li>  <li data_index="220" class="keyboard_double keyboard_w3_2">|</br>\\</li>    	</ul>    	<ul class="keyboard_row">  <li data_index="" class="keyboard_w2"></li>  <li data_index="65">A</li>  <li data_index="83">S</li>  <li data_index="68">D</li>  <li data_index="70">F</li>  <li data_index="71">G</li>  <li data_index="72">H</li>  <li data_index="74">J</li>  <li data_index="75">K</li>  <li data_index="76">L</li>  <li data_index="186" class="keyboard_double">:</br>;</li>  <li data_index="222" class="keyboard_double">"</br>\'</li>  <li data_index="" class="keyboard_w2"></li>    	</ul>    	<ul class="keyboard_row">  <li data_index="" class="keyboard_w5_2"></li>  <li data_index="90">Z</li>  <li data_index="88">X</li>  <li data_index="67">C</li>  <li data_index="86">V</li>  <li data_index="66">B</li>  <li data_index="78">N</li>  <li data_index="77">M</li>  <li data_index="188" class="keyboard_double">&lt;</br>,</li>  <li data_index="190" class="keyboard_double">&gt;</br>.</li>  <li data_index="191" class="keyboard_double">?</br>/</li>  <li data_index="" class="keyboard_w5_2"></li>    	</ul>    	<ul class="keyboard_row">  <li data_index="" class="keyboard_w8_7"></li>  <li data_index="" class="keyboard_w8_7"></li>  <li data_index="" class="keyboard_w8_7"></li>  <li data_index="32" class="keyboard_w8">space</li>  <li data_index="" class="keyboard_w8_7"></li>  <li data_index="" class="keyboard_w8_7"></li>  <li data_index="" class="keyboard_w8_7"></li>  <li data_index="" class="keyboard_w8_7"></li>    	</ul>    </div>    </div>';
		// var b = '';
		a.html(b)
	}
	function initStyle(a, b) {
		...
		c.find('.keyboard_row>li.keyboard_w8_7').css({
			'width': p(d * 1.3) - f + 'px'
		});
	...
	function addEL(d, f) {
		...
		function setBoardColor(n) {
			var n = n || 0;
			g.css({
				'box-shadow': '0 0 ' + p(s.boardColorsInsetSize) + 'px ' + p(s.boardColorsInsetSize) + 'px ' + t[n] + ' inset'
			})
		}
		...
		$(document).on('keydown', function(a) {
			var tmp = findKeyByCode(a.keyCode);
			// if (!b) {
			// 	alert('请切换至英文输入');
			// 	return
			// }
			// if (tmp == 8 || tmp == 9 || tmp == 13 || tmp == 16 || tmp == 17 || tmp == 18 || tmp == 20 || tmp == 27 || tmp == 91 || tmp == 33 || tmp == 34 || tmp == 35 || tmp == 36 || tmp == 37 || tmp == 38 || tmp == 39 || tmp == 40 || tmp == 46){}
			// else {keydown(tmp)}
			keydown(tmp)
		});
